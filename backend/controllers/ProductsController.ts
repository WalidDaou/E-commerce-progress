...
ProductsController.get('/filter', async (req, res) => {
    try {
        // @ts-ignore
        const { searchFilter, categoryFilter, productSorting, favoritesToggled } = req.query
        ...
        // if (favoritesToggled) {
        //     // @ts-ignore
        //     // const isInFavs = user.favoriteProductIds.includes(product
        //     filters = { ...filters, _id: { $in: User.favorites } }
        // }
